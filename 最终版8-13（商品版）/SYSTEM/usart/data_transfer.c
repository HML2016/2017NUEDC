...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_check = 0;
		ANO_DT_Send_Check(checkdata_to_send,checksum_to_send);//接收上位机校验
	}
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_version)
	{
		f.send_version = 0;
		ANO_DT_Send_Version(4,300,100,400,0);//版本号
	}
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_status)//欧拉角数据
	{
		f.send_status = 0;
		ANO_DT_Send_Status(Angle.Current_x,Angle.Goal_y,Angle.Goal_x,0,0,0);	
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_senser)//发送MPU6050和地磁信息
	{
		f.send_senser = 0;
//    	ANO_DT_Send_Senser(MPU6050_Raw_Data.Accel_X,MPU6050_Raw_Data.Accel_Y,MPU6050_Raw_Data.Accel_Z,
//						MPU6050_Raw_Data.Gyro_X,MPU6050_Raw_Data.Gyro_Y,MPU6050_Raw_Data.Gyro_Z,
//						MPU6050_Raw_Data.Acc_Offset_x,MPU6050_Raw_Data.Gyro_Offset_y,MPU6050_Raw_Data.Acc_Offset_z);
		ANO_DT_Send_Senser(positionX,positionY, 0,0,0,0,0,10*Pixy_Color_Inf.Pixy_Color_PosX,10*Pixy_Color_Inf.Pixy_Color_PosY);
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_senser2)//发送高度信息
	{
		f.send_senser2 = 0;
	//	ANO_DT_Send_Senser2(Pid.Err_y,ultra.height);//原始数据
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_rcdata = 0;
		ANO_DT_Send_RCData(RC_Ctl.rc.ch1+1500,RC_Ctl.rc.ch2+1500,RC_Ctl.rc.ch3+1500,RC_Ctl.rc.ch4+1500,
										RC_Ctl.rc.s1+1500,RC_Ctl.rc.s2+1500,0+1500,0+1500,0 +1500,0 +1500);
	}	
/////////////////////////////////////////////////////////////////////////////////////	
	else if(f.send_motopwm)
	{
		f.send_motopwm = 0;
		ANO_DT_Send_MotoPWM(Motor.num1,Motor.num2,Motor.num3,Motor.num4,0,0,0,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_power)
	{
		f.send_power = 0;
		ANO_DT_Send_Power(mpu6050_id,456);
	}
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid1)
	{
		f.send_pid1 = 0;
		ANO_DT_Send_PID(1,0.001*Pidv.Kp_x,0.001*Pidv.Ki_x,0.001*Pidv.Kd_x,0.001*Pid.Kp_x,0.001*Pid.Ki_x,0.001*Pid.Kd_x,
		0.001*Pidv.Kp_y,0.001*Pidv.Ki_y,0.001*Pidv.Kd_y);
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid2)
	{
		f.send_pid2 = 0;
		ANO_DT_Send_PID(2,0.001*Pid.Kp_y,0.001*Pid.Ki_y,0.001*Pid.Kd_y,0,0,0,0,0,0);
	}
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid3)
	{
...
//	}
    ...
    {
		LED_GRE=0;
        Pidv.Kp_x  = ( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
        Pidv.Ki_x  = ( (vs16)(*(data_buf+6)<<8)|*(data_buf+7) );
        Pidv.Kd_x  = ( (vs16)(*(data_buf+8)<<8)|*(data_buf+9) );
        Pid.Kp_x = ( (vs16)(*(data_buf+10)<<8)|*(data_buf+11) );
        Pid.Ki_x = ( (vs16)(*(data_buf+12)<<8)|*(data_buf+13) );
        Pid.Kd_x= ( (vs16)(*(data_buf+14)<<8)|*(data_buf+15) );
        Pidv.Kp_y	= ( (vs16)(*(data_buf+16)<<8)|*(data_buf+17) );
        Pidv.Ki_y 	= ( (vs16)(*(data_buf+18)<<8)|*(data_buf+19) );
        Pidv.Kd_y 	= ( (vs16)(*(data_buf+20)<<8)|*(data_buf+21) );
				if(f.send_check == 0)
				{
					f.send_check = 1;
    ...
    {
        Pid.Kp_y  = ( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
        Pid.Ki_y  = ( (vs16)(*(data_buf+6)<<8)|*(data_buf+7) );
        Pid.Kd_y  = ( (vs16)(*(data_buf+8)<<8)|*(data_buf+9) );
