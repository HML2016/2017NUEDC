...
#define IIC_SCL_H()      GPIO_SetBits(GPIOA,GPIO_Pin_12)
#define IIC_SCL_L()      GPIO_ResetBits(GPIOA,GPIO_Pin_12)
#define IIC_SDA_H()      GPIO_SetBits(GPIOA,GPIO_Pin_11)
#define IIC_SDA_L()      GPIO_ResetBits(GPIOA,GPIO_Pin_11)
#define IIC_SDA_Read()   GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_11)
